...
**Closed:** 2026-07-03 - option 1 (k3s native `etcd-s3`) to a **dedicated** B2
bucket `k3s-safeqbit-etcd` with an application key scoped to that bucket only
(blast-radius separation from the Velero credentials). Config appended to
